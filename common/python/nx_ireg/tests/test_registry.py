...
class TestIreg:
    ...
    def test_get_customization_by_host(self):
        ...
        assert ireg.get_customization_by_host(hostname, query_portal=True) == customization
        assert ireg.customizations.get(customization) == hostname
