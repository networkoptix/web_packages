...
${RECORDING MODE ERROR}                      //nx-radio/following-sibling::span[contains(text(),"${SELECT RECORDING MODE TEXT}")]
${FPS ERROR}                                 ${FPS INPUT}/following-sibling::span[contains(text(),"${SELECT FPS TEXT}")]
${QUALITY ERROR}                             ${QUALITY DROPDOWN}/ancestor::nx-select/following-sibling::span[contains(text(),"${SELCT QUALITY TEXT}")]
${SAVE ERROR}                                //nx-apply//div[contains(text(),"${MISSING SETTINGS TEXT}")]

${GOOD CAM JSON 1}                           {"audioEnabled": false,"cameraId": "{d6de2b74-9c74-2dad-8bc0-f1e10ba7b6b2}","cameraName": "good cam","motionType":"2","motionMask":"5,0,0,44,32","scheduleEnabled": false,"scheduleTasks":[{"fps":30,"recordingType":"RT_Always","streamQuality":"high","bitrateKbps":0,"endTime":86400,"startTime":0,"dayOfWeek":1},{"fps":30,"recordingType":"RT_Always","streamQuality":"high","bitrateKbps":0,"endTime":86400,"startTime":0,"dayOfWeek":2},{"fps":30,"recordingType":"RT_Always","streamQuality":"high","bitrateKbps":0,"endTime":86400,"startTime":0,"dayOfWeek":3},{"fps":30,"recordingType":"RT_Always","streamQuality":"high","bitrateKbps":0,"endTime":86400,"startTime":0,"dayOfWeek":4},{"fps":30,"recordingType":"RT_Always","streamQuality":"high","bitrateKbps":0,"endTime":86400,"startTime":0,"dayOfWeek":5},{"fps":30,"recordingType":"RT_Always","streamQuality":"high","bitrateKbps":0,"endTime":86400,"startTime":0,"dayOfWeek":6},{"fps":23,"recordingType":"RT_Always","streamQuality":"high","bitrateKbps":0,"endTime":86400,"startTime":0,"dayOfWeek":7}]}
