...
${2FA DISABLE MODAL BTN}                    //two-fa-modal-content//button[@id="disableFinish"]
${2FA DISABLE MODAL RED COLOR}              rgba(220, 53, 69, 1)
${2FA DISABLE MODAL CANCEL BTN}             //two-fa-modal-content//button[@id="disableCancel"]
...
${2FA SETTINGS MODAL APPLY BTN}             //two-fa-modal-content//button//span[text()="${APPLY CHANGES BUTTON TEXT}"]
${2FA SETTINGS MODAL CANCEL BTN}            //two-fa-modal-content//button//span[text()="${CANCEL BUTTON TEXT}"]