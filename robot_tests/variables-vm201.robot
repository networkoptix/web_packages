...
${ACCOUNT NOT FOUND MESSAGE}          //form[@name='loginForm']//label[text()="${ACCOUNT DOES NOT EXIST TEXT}"]
...
${ADD USER BUTTON SYSTEMS}               //div[@process-loading='gettingSystem']//button[@ng-click='share()']
${ADD USER BUTTON DISABLED}              //div[@process-loading='gettingSystem']//button[@ng-click='share()' and @ng-disabled='!system.isAvailable']
...
${ADD USER MODAL}                        //form[@name='shareForm']
${ADD USER EMAIL}                        //form[@name='shareForm']//input[@id='email']
${ADD USER PERMISSIONS DROPDOWN}         //form[@name='shareForm']//nx-permissions-select//button[@id='permissionsSelect']
${ADD USER BUTTON MODAL}                 //form[@name='shareForm']//button[text()='${ADD USER BUTTON TEXT}']
${ADD USER CANCEL}                       //form[@name='shareForm']//button[text()='${CANCEL BUTTON TEXT}']
${ADD USER CLOSE}                        //form[@name='shareForm']//button[@data-dismiss='modal']
${ADD USER PERMISSIONS HINT}             //form[@name='shareForm']//span[contains(@class,'help-block')]
