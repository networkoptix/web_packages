!function (e, t) {
    ...
    var n, o, s,
        f = (s = Error, r(n = l, o = s), void (n.prototype = null === o ? Object.create(o) : (c.prototype = o.prototype, new c)), l);
    ...
    var _ = "[DEFAULT]", N = (P.prototype.get = function (e) {
        void 0 === e && (e = _);
        ...
        var t = a({identifier: _, optional: !1}, e), r = t.identifier, n = t.optional,
        ...
        try {
            for (var n = d(this.instancesDeferred.entries()), i = n.next(); !i.done; i = n.next()) {
                var o = p(i.value, 2), a = o[0], s = o[1], c = this.normalizeInstanceIdentifier(a);
                try {
    ...
    var D, F = S.INFO, x = (Object.defineProperty(L.prototype, "logLevel", {
        get: function () {
    ...
    var T,
        ...
        H = new x("@firebase/app"), W = (Object.defineProperty(G.prototype, "automaticDataCollectionEnabled", {
            ...
            return void 0 === t && (t = M), this.checkDestroyed_(), this.container.getProvider(e).getImmediate({identifier: t})
    ...
    function Y(c) {
        var l = {}, p = new Map, u = {
            ...
            }, apps: null, SDK_VERSION: $, INTERNAL: {
                registerComponent: h, removeApp: function (e) {
                    delete l[e]
                }, components: p, useAsService: function (e, t) {
        ...
        function h(r) {
            ...
            if (p.set(n, r), "PUBLIC" === r.type) {
                var i = function (e) {
                    if (void 0 === e && (e = f()), "function" != typeof e[n]) throw V.create("invalid-app-argument", {appName: n});
                    return e[n]()
                };
    ...
    var K = function e() {
        ...
        return t.INTERNAL = a(a({}, t.INTERNAL), {
            createFirebaseNamespace: e, extendNamespace: function (e) {
                v(t, e)
            }, createSubscribe: b, ErrorFactory: u, deepExtend: v
        }), t
    ...
    (X = te).INTERNAL.registerComponent(new E("platform-logger", function (e) {
        return new Z(e)
    }, "PRIVATE")), X.registerVersion(B, "0.5.1", ee), X.registerVersion("fire-js", "");
