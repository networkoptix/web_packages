...
def test_password_validation(user: CloudAccount):
    ...
    with get_chrome() as driver:
        ...
        reset_password = ResetPasswordForm(driver)
        reset_password.wait_until_visible()
        reset_password.type_new_password('asdfghj')
        reset_password.wait_for_error_label('TOO SHORT')
        reset_password.get_new_password_input().clear_text_like_users()
        reset_password.click_next()
        reset_password.wait_for_password_required_error()
        reset_password.type_new_password('Кенгшщзх')
        reset_password.wait_for_error_label('INCORRECT')
        reset_password.type_new_password('☠☿☂⊗⅓∠∩λ℘웃♞⊀☻★ ')
        reset_password.wait_for_error_label('INCORRECT')
        reset_password.type_new_password('您都可以享受源源不絕的好禮及優惠')
        reset_password.wait_for_error_label('INCORRECT')
        reset_password.type_new_password('qweasdzxc123®™')
        reset_password.wait_for_error_label('INCORRECT')
        reset_password.type_new_password(r'pass!@#$%^&*()_-+=;:\'"`~,./\|?[]{}')
        reset_password.wait_for_success_label('FAIR')
        reset_password.type_new_password(' ' + base_password)
        reset_password.wait_for_error_label('INCORRECT')
        reset_password.type_new_password(base_password + ' ')
        reset_password.wait_for_error_label('INCORRECT')
        reset_password.type_new_password('adrhartjad')
        reset_password.wait_for_error_label('WEAK')
        reset_password.type_new_password('ADRHARTJAD')
        reset_password.wait_for_error_label('WEAK')
        reset_password.type_new_password('13462344')
        reset_password.wait_for_error_label('WEAK')
        reset_password.type_new_password('!@#$%^&*()_-+=')
        reset_password.wait_for_error_label('WEAK')
        reset_password.type_new_password('multPASS')
        reset_password.wait_for_success_label('FAIR')
        reset_password.type_new_password('mult1234')
        reset_password.wait_for_success_label('FAIR')
        reset_password.type_new_password('mult!@#$')
        reset_password.wait_for_success_label('FAIR')
        reset_password.type_new_password('MULT1234')
        reset_password.wait_for_success_label('FAIR')
        reset_password.type_new_password('MULT!@#$')
        reset_password.wait_for_success_label('FAIR')
        reset_password.type_new_password('1234!@#$')
        reset_password.wait_for_success_label('FAIR')
        reset_password.type_new_password('qweASD123')
        reset_password.wait_for_success_label('GOOD')
        reset_password.type_new_password('qweASD!@#')
        reset_password.wait_for_success_label('GOOD')
        reset_password.type_new_password('qwe123!@#')
        reset_password.wait_for_success_label('GOOD')
        reset_password.type_new_password('QWE123!@#')
        reset_password.wait_for_success_label('GOOD')
        reset_password.type_new_password('qweasd123')
        reset_password.wait_for_error_label('TOO COMMON')
