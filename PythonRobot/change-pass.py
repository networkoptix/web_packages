...
def password_is_actually_changed_and_login_works_with_new_password():
    ...
    robot_keywords.wait_until_elements_are_visible(driver, [rb.CHANGE_PASSWORD_BUTTON, rb.CANCEL_PASSWORD_CHANGES_BUTTON])
    robot_keywords.click_button(driver, rb.CHANGE_PASSWORD_BUTTON)
    robot_keywords.elements_should_not_be_visible(driver, [rb.CHANGE_PASSWORD_BUTTON, rb.CANCEL_PASSWORD_CHANGES_BUTTON])
