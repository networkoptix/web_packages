...
def check_default_download_tab():
    ...
    Footer(windows_user_agent_driver, 'cloud').get_downloads_link().click()
    ...
    Footer(linux_user_agent_driver, 'cloud').get_downloads_link().click()
    ...
    Footer(mac_user_agent_driver, 'cloud').get_downloads_link().click()
