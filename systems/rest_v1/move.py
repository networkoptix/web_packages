...
async def move_group(dst_id, src_id):
    ...
    return await GroupView().move_group_to_group(connector.send_batch, src_id, dst_id)
...
async def move_system(dst_id, system_id):
    ...
    return await GroupView().move_system_to_group(connector.send_batch, dst_id, system)
