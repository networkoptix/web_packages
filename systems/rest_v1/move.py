...
async def move_group(dst_id, src_id):
    ...
    return await GroupView.move_group_to_group(connector.share_system, src_id, dst_id, connector.email)
...
async def move_system(dst_id, system_id):
    ...
    return await GroupView.move_system_to_group(connector.share_system, dst_id, system, connector.email)
