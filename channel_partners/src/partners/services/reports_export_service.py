...
class ReportsExportServiceBase:
    """
    ...
    def generate_report_sheet(self):
        ...
        """
        self.sheet.title = self.service.name
        self.make_header()
...
class PartnerReportsExportBase(ReportsExportServiceBase):
    """
...
class OrganizationReportsExportBase(ReportsExportServiceBase):
    """
...
class ChannelPartnerSummarySheet(SummarySheetBase):
    """
...
class OrganizationSummarySheet(SummarySheetBase):
    """
