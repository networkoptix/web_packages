...
def cp_direct_children_count(channel_partner_id: str) -> str:
    return f'cp_direct_children-count-{channel_partner_id}'


def direct_organization_children_count(channel_partner_id: str) -> str:
    return f'direct_organization_children_count_{channel_partner_id}'


def cp_monthly_charges(id: str, start_date: str) -> str:
    return f'monthly-charges-{id}-{start_date}'


def organization_system_count(id: str) -> str:
