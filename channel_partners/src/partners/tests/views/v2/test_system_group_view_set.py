...
class TestSystemGroupViewSet:
    ...
    def test_destroy_403_permission(self, mock_auth_with_user, arf):
...
class TestSystemGroupViewSetCreate:
    ...
    def test_2xx_org_admin(self, mock_auth_with_user, arf):
        mock_auth_with_user(self.org_admin)
        data = {
            'organizationId': self.org_1.id,
            'parentId': None,
    ...
    def test_2xx_cp_user_cpal_org_admin(self, mock_auth_with_user, arf):
        mock_auth_with_user(self.cp_user)
        data = {
            'organizationId': self.org_1.id,
            'parentId': None,
    ...
    def test_403_cp_user_cpal_health_viewer(self, mock_auth_with_user, arf):
        self.org_1.channel_partner_access_level_id = OrganizationRoles.SYSTEM_HEALTH_VIEWER
        self.org_1.save()
        mock_auth_with_user(self.cp_user)
        data = {
    ...
    def test_403_cp_user_no_cpal(self, mock_auth_with_user, arf):
        self.org_1.channel_partner_access_level_id = None
        self.org_1.save()
        mock_auth_with_user(self.cp_user)
        data = {
