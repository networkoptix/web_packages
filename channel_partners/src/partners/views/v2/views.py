...
class CloudSystemViewSet(VersionedViewMixin,
    ...
    def get_permissions(self):
        ...
        if self.action == 'destroy':
            perms.append(CanPerformChannelPartnerAction(CloudSystemId.can_disconnect, system_allowed=True,
    ...
    def services(self, request, id):
        system: CloudSystemId = self.get_object()
        services: QuerySet[ChannelPartnerService] = system.all_services.filter(enabled=True)
