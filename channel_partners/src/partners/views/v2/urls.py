...
from partners.views.v2.grant_access_views import GrantAccessView
from partners.views.v2.internal_views import (
    all_org_users,
...
def get_urlpatterns():
    ...
    channel_partner_internal_urls = [
        ...
        # Grant access API is allowed only in DEBUG mode, handled inside the view
        path('grant_access/', GrantAccessView.as_view(actions={'post': 'create'}), name='grant_access_api'),
    ]
