...
| partners | views.py                 | CloudSystemViewSet.perform_destroy                | INFO     | Got server error. Error will be ignored.             | status_code, response                                                                                 |
| partners | views.py                 | CloudSystemViewSet.perform_destroy                | INFO     | "Got transport error."                               | exception                                                                                             |
