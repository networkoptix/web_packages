...
const typeLintBlacklist = [
    ...
    '**/cameras/motion-detection-settings/motion-detection-overlay/MotionMaskRenderer.ts',
    '**/cameras/motion-detection-settings/motion-detection-overlay/MotionMaskState.ts',
