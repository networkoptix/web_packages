...
const typeLintBlacklist = [
    ...
    'app/src/components/content-block/alert/block-error.component.spec.ts',
    'app/src/components/content-block/content-block.component.spec.ts',
    'app/src/components/content-block/content-block.component.ts',
    'app/src/components/cookie-banner/cookie-banner.component.spec.ts',
    ...
    'app/src/components/dropdowns/drop-menu/additional-systems-tile/additional-systems-tile.component.ts',
    ...
    'app/src/components/dropdowns/three-dot/three-dot.component.ts',
    ...
    'app/src/components/footer/footer.component.spec.ts',
    'app/src/components/footer/footer.component.ts',
    'app/src/components/graph/graph.component.ts',
    'app/src/components/header/header.component.spec.ts',
    ...
    'app/src/components/header/new-header/header-level-one/header-level-one.component.ts',
    ...
    'app/src/components/header/new-header/mobile/mobile.component.ts',
    'app/src/components/header/new-header/new-header.component.ts',
    ...
    'app/src/components/overlay-modal/overlay-modal.component.ts',
    ...
    'app/src/components/ribbon/ribbon.types.ts',
    ...
    'app/src/decorators/debounce.ts',
    ...
    'app/src/dialogs/client-2fa-warning/client-2fa-warning.component.ts',
    'app/src/dialogs/cloud-storage/action-common/BaseCloudStorageActionModalContent.ts',
    'app/src/dialogs/cloud-storage/activate/cloud-storage-activate.component.ts',
    'app/src/dialogs/cloud-storage/delete/cloud-storage-delete.component.ts',
    'app/src/dialogs/cloud-storage/modify/cloud-storage-modify.component.ts',
    'app/src/dialogs/cloud-storage/move/cloud-storage-move.component.ts',
    ...
    'app/src/dialogs/disconnect/disconnect.component.ts',
    ...
    'app/src/directives/feature.directive.ts',
    ...
    'projects/authorization/src/app/components/not-secure/not-secure.component.ts',
