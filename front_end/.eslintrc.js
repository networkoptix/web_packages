...
const typeLintBlacklist = [
    ...
    '**/permissions/permissions.component.ts',
    ...
    '**/connect-cloud/connect-cloud.component.ts',
    '**/delete-cloud-user/delete-cloud-user.component.ts',
    ...
    '**/remove-user/remove-user.component.ts',
    ...
    '**/dynamic-form-apply-example/dynamic-form-apply-example.component.ts',
    '**/form-apply-example/form-apply-example.component.ts',
    '**/form-elements/form-elements.component.ts',
    '**/ngrx-demo/store/groups/groups.selectors.ts',
    '**/section-apply-example/section-apply-example.component.ts',
    ...
    '**/system.service/camera-manager/camera-manager-types.ts',
    '**/system.service/camera-manager/camera-manager.ts',
