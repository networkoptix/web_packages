...
const typeLintBlacklist = [
    ...
    'app/src/components/dropdowns/drop-menu/system-tile/system-tile.component.ts',
    ...
    'app/src/components/header/new-header/header-level-two/header-level-two.component.ts',
    ...
    'app/src/components/paginator/paginator.component.ts',
    ...
    'app/src/components/placeholders/open-client-section/open-client-section.component.ts',
    'app/src/components/placeholders/page/page-placeholder.component.ts',
    'app/src/components/placeholders/player/player-placeholder.component.ts',
    'app/src/components/placeholders/section/section-placeholder.component.ts',
    'app/src/components/popover/popover-config.ts',
    'app/src/components/popover/popover-ref.ts',
    'app/src/components/popover/popover.service.ts',
    'app/src/components/popover/popover/popover.component.ts',
    'app/src/components/process-button/process-button.component.ts',
    'app/src/components/process-cancel-Button/process-cancel-button.component.ts',
    ...
    'app/src/components/stepper/stepper.component.ts',
    'app/src/components/switch/switch.component.ts',
    'app/src/components/systems-list/list.component.ts',
    'app/src/components/theme-switcher/theme-switcher.component.ts',
    'app/src/components/toast/toast.component.ts',
    'app/src/components/toast/toast.container.ts',
    'app/src/components/tooltip/tooltip.component.ts',
    'app/src/components/update-webadmin-session/update-webadmin-session.component.ts',
    'app/src/components/widgets/asset-explorer/asset-explorer-widget.component.ts',
    ...
    'app/src/dialogs/login-webadmin/login-webadmin.component.ts',
    ...
    'app/src/dialogs/select-time-range-datetime-local/select-time-range.component.ts',
    'app/src/dialogs/select-time-range-full-fallback/select-time-range.component.ts',
    ...
    'app/src/dialogs/toast.service.ts',
    ...
    'app/src/directives/nx-arrow-nav.ts',
    'app/src/directives/nx-click-elsewhere.ts',
    'app/src/directives/nx-editable.directive.ts',
    'app/src/directives/nx-focus-me.ts',
    'app/src/directives/nx-intersection.directive.ts',
    'app/src/directives/nx-projected-link-handler.directive.ts',
    'app/src/directives/nx-resize.directive.ts',
    'app/src/directives/nx-tooltip.directive.ts',
    'app/src/interceptors/cloud-unavailable-interceptor.ts',
    'app/src/interceptors/uri-cache-interceptor.service.ts',
    'app/src/pages/404/404.component.ts',
    ...
    'app/src/pages/account/type-resolver.ts',
    ...
    'app/src/pages/api-tool/swagger/swagger-api-information/swagger-api-information.component.ts',
    'app/src/pages/api-tool/swagger/swagger-spinner/swagger-spinner.component.ts',
    'app/src/pages/api-tool/swagger/swagger-textarea/swagger-textarea.component.ts',
    'app/src/pages/api-tool/swagger/swagger-types.ts',
    'app/src/pages/api-tool/swagger/swagger-utils.ts',
    'app/src/pages/api-tool/swagger/swagger.component.ts',
    'app/src/pages/cloud-owner-authorization/cloud-owner-authorization.component.ts',
    ...
    'app/src/pages/developer-console/console/menu/console-menu.component.ts',
    ...
    'app/src/pages/developers/about/capabilities/capabilities.component.spec.ts',
    ...
    'app/src/pages/developers/about/get-started/get-started.component.spec.ts',
    ...
    'app/src/pages/download-history/type-resolver.ts',
    ...
    'app/src/pages/health/update-info/update-info.component.ts',
    ...
    'app/src/pages/new-landing/background-graphic/background-graphic.component.ts',
    'app/src/pages/new-landing/content-container/content-container.ts',
    'app/src/pages/new-landing/intro-text/intro-text.component.ts',
    'app/src/pages/new-landing/landing-content-block/landing-content-block.component.ts',
    'app/src/pages/new-landing/learn-more/learn-more.component.ts',
    'app/src/pages/new-landing/mask/mask.component.ts',
    ...
    'app/src/pages/sandbox/ngrx-demo/components/groups/group-list/group-list.component.ts',
    'app/src/pages/sandbox/ngrx-demo/components/groups/groups.component.ts',
    ...
    'app/src/pages/sandbox/validation/validation.component.ts',
    ...
    'app/src/pages/systems/settings/cameras/motion-detection-overlay/motion-detection-overlay.component.ts',
    'app/src/pages/systems/settings/cameras/motion-detection-overlay/motion-detection-types.ts',
    ...
    'app/src/pages/systems/settings/licenses/summary/summary.component.spec.ts',
    'app/src/pages/systems/settings/licenses/summary/summary.component.ts',
    ...
    'app/src/pages/systems/view/services/cameraQualityStorage.service.ts',
    'app/src/pages/systems/view/services/cameraTransportStorage.service.ts',
    ...
    'app/src/pages/systems/view/vms-client/submodules/timeline/components/time-under-mouse/time-under-mouse.component.ts',
    ...
    'app/src/pages/systems/view/vms-client/submodules/timeline/services/canvas-renderer/ruler/animationPrimitives/AnimatedInteger.ts',
    'app/src/pages/systems/view/vms-client/submodules/timeline/services/canvas-renderer/ruler/intervals/utils/alignTimeStamp.spec.ts',
    'app/src/pages/systems/view/vms-client/submodules/timeline/services/canvas-renderer/ruler/intervals/utils/alignTimeStamp.ts',
    ...
    'app/src/pages/systems/view/vms-client/submodules/timeline/services/canvas-renderer/ruler/intervals/utils/isAlignedByIrregularInterval.ts',
    ...
    'app/src/pages/systems/view/vms-client/submodules/timeline/services/canvas-renderer/stripy-bar/slope.ts',
    'app/src/pages/systems/view/vms-client/submodules/timeline/services/canvas-renderer/stripy-bar/stripy-bar.ts',
    'app/src/pages/systems/view/vms-client/submodules/timeline/services/canvas-renderer/timeline.debug-canvas-renderer.service.ts',
    ...
    'app/src/pages/systems/view/vms-client/submodules/timeline/services/timeline.wheel-handler.service.ts',
    'app/src/pages/systems/view/vms-client/submodules/vms/components/highlighted-string/highlighted-string.component.ts',
    'app/src/pages/systems/view/vms-client/submodules/vms/components/media-server-list-header/media-server-list-header.component.ts',
    ...
    'app/src/pages/systems/view/vms-client/submodules/vms/pipes/ip_info.pipe.ts',
    ...
    'app/src/routeGuards/applyGuard.ts',
    'app/src/routeGuards/feature.guard.ts',
    'app/src/routeGuards/systemGuard.ts',
    ...
    'app/src/services/csv-export.service.ts',
    ...
    'app/src/services/poll.service.spec.ts',
    'app/src/services/poll.service.ts',
    'app/src/services/process.service/process.service.spec.ts',
    'app/src/services/process.service/process.service.ts',
    'app/src/services/process.service/process.ts',
    'app/src/services/scroll-mechanics.service.spec.ts',
    'app/src/services/scroll-mechanics.service.ts',
    'app/src/services/session.service.spec.ts',
    ...
    'app/src/services/system.service/base/base-manager.ts',
