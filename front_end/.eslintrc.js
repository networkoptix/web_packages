...
const typeLintBlacklist = [
    ...
    'src/app/dialogs/add-storage/add-storage.component.ts',
    'src/app/dialogs/add-user/add-user.component.ts',
    'src/app/dialogs/add-widget/add-widget.component.ts',
    'src/app/dialogs/apply/apply.component.ts',
    'src/app/dialogs/change-password/change-password.component.ts',
    'src/app/dialogs/change-storage/change-storage.component.ts',
    'src/app/dialogs/cloud-storage/action-common/BaseCloudStorageActionModalContent.ts',
    'src/app/dialogs/connect-cloud/connect-cloud.component.ts',
    'src/app/dialogs/delete-cloud-user/delete-cloud-user.component.ts',
    'src/app/dialogs/detach-server/detach-server.component.ts',
    'src/app/dialogs/dialog-config.ts',
    'src/app/dialogs/dialog-ref.ts',
    'src/app/dialogs/dialogs.service.ts',
    'src/app/dialogs/download-async/download-async.component.ts',
    'src/app/dialogs/download-async/package-handler.ts',
    'src/app/dialogs/edit/edit.component.ts',
    'src/app/dialogs/embed/embed.component.ts',
    'src/app/dialogs/generic/generic.component.ts',
    'src/app/dialogs/mandatory-2fa/mandatory-2fa.component.ts',
    'src/app/dialogs/merge/merge.component.ts',
    'src/app/dialogs/merge/stateForMergeDialog.ts',
    'src/app/dialogs/merge/stateMachine.ts',
    'src/app/dialogs/message/message.component.ts',
    'src/app/dialogs/remove-system/remove-system.component.ts',
    'src/app/dialogs/remove-user/remove-user.component.ts',
    'src/app/dialogs/reset-backup/reset-backup.component.ts',
    'src/app/dialogs/reset-server/reset-server.component.ts',
    'src/app/dialogs/select-time-range-native-fallback/select-time-range.component.ts',
    'src/app/dialogs/simple-dialogs.service.ts',
    'src/app/dialogs/two-fa/two-fa.component.ts',
    'src/app/dialogs/update-camera-credentials/update-camera-credentials.component.ts',
    'src/app/directives/nx-editable.directive.ts',
    'src/app/directives/nx-intersection.directive.ts',
    'src/app/directives/nx-projected-link-handler.directive.ts',
