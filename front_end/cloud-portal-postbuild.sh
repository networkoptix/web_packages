...
#    cp ./common/customization/webadmin_logo.png ./dist/images/logo.png
    ...
    sed -i -e 's/<title><\/title>/<title>{{title}}<\/title>\n<script type="application\/ld+json">{"@context" : "https:\/\/schema.org", "@type" : "WebSite", "name" : "{{site_name}}", "url" : "{{site_url}}"}<\/script>/' ./dist/index.mustache.html
