...
module.exports = function (base) {
    const coverageType = type => ({
        dir: require('path').join(__dirname, `./coverage/${base}/${type}`),
        type
    });
    ...
    return function (config) {
        config.set({
            ...
            coverageReporter: {
                reporters: [coverageType('html'), coverageType('text-summary'), coverageType('cobertura')],
            },

            junitReporter: {
                outputDir: require('path').join(__dirname, `./reports/${base}`) // results will be saved as $outputDir/$browserName.xml
            },
