...
const lazyRoutes: Routes = [
    ...
    },
    {
        path: 'settings',
        loadChildren: () =>
            import('@pages/systems/webadmin-system.module').then(m => m.NxSystemModule),
    },
    {
        path: 'monitoring',
        loadChildren: () =>
    ...
    },
    {
        ...
        loadChildren: () =>
            import('@pages/server-documentation/server-documentation.module').then(
                m => m.NxServerDocumentationModule,
            ),
        pathMatch: 'full',
    },
    {
