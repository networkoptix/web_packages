...
function isUntypedValue(expression) {
    ...
    const isUndefined = expression.type === utils_1.AST_NODE_TYPES.Identifier && expression.name === 'undefined';
    const isEmptyArray = expression.type === utils_1.AST_NODE_TYPES.ArrayExpression && !expression.elements.length;
    const isEmptyObject = expression.type === utils_1.AST_NODE_TYPES.ObjectExpression && !expression.properties.length;
