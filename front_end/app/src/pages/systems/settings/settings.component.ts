    ...
    updateAlert() {
        ...
        if (!this.system.isOnline) {
            ...
            const secondarySystem = this.systemsService.systems
                .find(system => secondary.id === system.id) || this.LANG.system.mergeUnknownName;
            const template =
                `<div class="my-1">
                    <div class="larger"><strong>${secondarySystem.name}</strong> ${this.LANG.ribbon.beingMerged.to}</div>
