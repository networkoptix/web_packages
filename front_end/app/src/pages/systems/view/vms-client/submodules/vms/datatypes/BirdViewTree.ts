...
export class BirdViewTree {
    ...
    protected _spareArchiveDetails (startMs: ms, endMs: ms, minGapMs: ms) {
        ...
        // let firstFilteredRecordIndex = l // the first record to end after startMs
        // let lastFilteredRecordIndex = r // the last record to start before endMs
        ...
        // console.log(startMs, endMs, minGapMs, '|', firstFilteredRecordIndex, lastFilteredRecordIndex)

        // const maxDetailizedLength = lastFilteredRecordIndex - firstFilteredRecordIndex

        // const records = []
        // let lastAdded = undefined
        // for (let i = firstFilteredRecordIndex; i <= lastFilteredRecordIndex; i++) {
