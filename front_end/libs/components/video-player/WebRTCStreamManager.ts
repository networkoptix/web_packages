...
const removeAuth = (webRtcUrl: string): string => webRtcUrl.split('&auth=')[0];
...
export class WebRTCStreamManager {
    ...
    #close = (): void => {
        ...
        WebRTCStreamManager.EXISTING_CONNECTIONS[this.webRtcUrlFactory()] = null;
    };
     ...
     * @param webRtcUrlFactory () => string
     */
    constructor(public webRtcUrlFactory: () => string) {
        this.#initWebSocket();
