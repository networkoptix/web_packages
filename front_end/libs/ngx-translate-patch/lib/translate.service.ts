...
export class TranslateService {
    ...
    private _onTranslationChange: EventEmitter<TranslationChangeEvent> =
        new EventEmitter<TranslationChangeEvent>();
    private _onLangChange: EventEmitter<LangChangeEvent> = new EventEmitter<LangChangeEvent>();
    private _onDefaultLangChange: EventEmitter<DefaultLangChangeEvent> =
    ...
    private retrieveTranslations(lang: string): Observable<any> | undefined {
        ...
        if (typeof this.translations[lang] === 'undefined' || this.extend) {
            this._translationRequests[lang] =
                this._translationRequests[lang] || this.getTranslation(lang);
    ...
    public getParsedResult(translations: any, key: any, interpolateParams?: Object): any {
        ...
        if (
            ...
            res = this.parser.interpolate(
                this.parser.getValue(this.translations[this.defaultLang], key),
                interpolateParams,
            );
        }
