...
describe('Bootstrap Provider', () => {
    it('should create the service', async () => {
        const { bootstrapService } = await setupBootstrapProvider();
        expect(bootstrapService).toBeTruthy();
    });

    /**
     * TODO: Update these tests. The bootstrap service has been refactored and the tests are no longer valid.
     */
