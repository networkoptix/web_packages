...
describe('Process service', () => {
    ...
    it('should create process and fail w/ LANG defined error ', async () => {
        ...
        expect(toastSpy).toHaveBeenCalledWith(staticLang.errorCodes.fail, 'danger', toastOptions);
    });
    ...
    it('should create process and fail w/ settings defined error ', async () => {
        ...
        expect(toastSpy).toHaveBeenCalledWith('failed forbidden', 'danger', toastOptions);
    });
    ...
    it('should create process and fail w/ error.type ', async () => {
        ...
        expect(toastSpy).toHaveBeenCalledWith('Network Connection Fail', 'danger', toastOptions);
    });
    ...
    it('should create process and fail w/ 2fa error.errorText ', async () => {
        ...
        expect(toastSpy).toHaveBeenCalledWith(
            staticLang.dialogs.message.twoFactor.required,
            'danger',
            toastOptions,
        );
    });
