    ...
    describe('with full menu content', () => {
        ...
        describe('level1 nodes', () => {
            it('should have level1 nodes', async () => {
                const { debugElement } = await setup(menuContent);
                const level1nodes = debugElement.nativeElement.querySelectorAll(
                    '.nx-menu nx-level-1-item',
                );
            ...
            describe('Admin node', () => {
                it('should have level1 node', async () => {
                    const { debugElement } = await setup(menuContent);
                    const adminNodeContainer = debugElement.nativeElement.querySelector(
                        '.nx-menu .level-1-container',
                    );
                    ...
                    const adminNodeIcon = adminNodeContainer.querySelector(
                        'nx-level-1-item a .menu-level-1-icon svg-icon',
                    );
                ...
                it('should have level3 "General"', async () => {
                    ...
                    const { textContent: label } = general.querySelector('.menu-level-3-label');
                ...
                it('should have level3 "Licenses"', async () => {
                    ...
                    const { textContent: label } = licenses.querySelector('.menu-level-3-label');
                ...
                it('should filter items', async () => {
                    ...
                    expect(component.menuContent[0].level3[0].additionalLabel).toBe(
                        '192.168.5.100',
                    );

                    const searchHighlight = debugElement.nativeElement.querySelector(
