...
import { NxInformationV2StepperComponent } from './information-v2-stepper.component';
...
function nonEmptyInformation(information: SupportInformationServer): boolean {
...
@Component({
    selector: 'nx-information-v2',
    templateUrl: 'information-v2.component.html',
    styleUrls: ['information-v2.component.scss'],
    standalone: true,
    imports: [
        CommonModule,
        CdkStepperModule,
        ...
        PipesModule,
        forwardRef(() => NxInformationV2StepperComponent),
...
export class NxInformationV2Component {
    icons = icons;
    ...
    information = computed<SupportInformationServer>(
        () => this.channelPartner().supportInformation,
    );
    ...
    private doubleFormArrayToApiArray(formArray: StringControlArray): InfoRowServer[] {
