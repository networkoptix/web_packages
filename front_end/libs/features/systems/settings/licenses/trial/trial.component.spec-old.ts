...
//                 expect(line1.textContent.trim()).toBe('You have an unused trial license.');
//                 expect(line2.textContent.trim()).toBe('Once activated, it will allow you to record up to 4 cameras for 30 days.');
//             });

//             it('should have button w/ caption', () => {
//                 expect(button).toBeTruthy();
//                 expect(button.textContent.trim()).toBe('Activate Trial License');
//             });
//         });
