...
const lazyRoutes: Routes = [
    {
        path: 'redirect-oauth',
        loadChildren: () =>
            import('@authorization/src/app/oauth-redirect/oauth-redirect.module').then(
                m => m.NxOAuthRedirectModule,
            ),
    },
    {
        path: 'authorize',
        loadChildren: () =>
            import('@authorization/src/app/components/authorize.module').then(
                m => m.NxAuthorizeModule,
            ),
    },
    {
        path: '**',
...
@NgModule({
    ...
    declarations: [],
    providers: [ApplyGuard, AuthGuard, RedirectAuthGuard],
    exports: [],
})
