...
angular.module('nxCommon')
    ...
    function ($http, $q, $location, $rootScope, $log) {
        ...
        * */
        ...
        // var proxy = 'https://90e40fde-7936-47b4-8b5d-5731898ab185.relay.vmsproxy.hdw.mx';
        ...
        ServerConnection.prototype._getUrlBase = function(){
            this.systemId = $location.search().id;
            this._authGet = $location.search().authGet;
            this._authPost = $location.search().authPost;
            this._authPlay = $location.search().authPlay;
            Config.trafficRelayHost = $location.search().relayHost;
            
            return window.location.protocol +'//' + Config.trafficRelayHost.replace('{systemId}', this.systemId);
        };
        ...
        ServerConnection.prototype.getCurrentUser = function (forcereload){
            ...
            if (self.userEmail) { // Cloud portal mode - getCurrentUser is not working
                ...
                return self.userRequest = this._get('/web/api/getCurrentUser')
                    .then(function(result) {
