...
user_email__body = openapi.Schema(type=openapi.TYPE_STRING, description="The sender's email.")
user_name__body = openapi.Schema(type=openapi.TYPE_STRING, description="The sender's name.")
...
notification_type__body = openapi.Schema(type=openapi.TYPE_STRING, description="Determines the subject of the message.")
notification_user_email__body = openapi.Schema(type=openapi.TYPE_STRING, description="Who the email will be sent to.")
...
@swagger_auto_schema(method="POST",  auto_schema=None,
                     ...
                     request_body=openapi.Schema(
                         ...
                         required=["customization", "message", "type", "user_email"]
                     ))
@api_view(['POST'])
@permission_classes((AllowAny, ))
