...
@swagger_auto_schema(method='GET',
                     ...
                     responses={
                         ...
                         status.HTTP_404_NOT_FOUND: RELEASE_NOTES_NOT_FOUND
                     })
@api_view(("GET", ))
...
def get_release_note(request, asset_id=None):
    ...
    serializer = ReleaseNotesSerializer.generate([release_note], request)
    serializer.is_valid()
...
@swagger_auto_schema(method='GET',
                     ...
                     responses={
                         status.HTTP_200_OK: ReleaseNotesListSerializer()
                     })
@api_view(("GET", ))
@permission_classes((AllowAny, ))
