...
from cms.models import Context, DataStructure, Product, ProductType, get_cloud_portal_product, Language, DataRecord
...
def get_article(request, url_param, **kwargs):
    ...
    article = Product.objects.filter(
        ...
        datarecord__data_structure__name='url', customizations__name__in=[settings.CUSTOMIZATION],
