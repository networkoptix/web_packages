...
def find_actual_values(data_structures, asset, current_version, show_pending, show_drafts, name_filter=[]):
...
def generate_context_dicts_with_actual_values(show_pending, show_drafts, contexts, data_structures, asset, current_version):
