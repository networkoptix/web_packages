...
urlpatterns = [
    ...
    path('documentation/kb/<str:name>/sync_search', documentation.sync_search, name='sync_search'),
    path('documentation/sync_search', documentation.sync_search, name='sync_search'),
